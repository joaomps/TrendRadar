...
# -*- coding: utf-8 -*-
"""
Batch translation script for main.py
Translates all Chinese strings to English
"""
...
TRANSLATIONS = [
    ...
    # Print messages
    ('print("频率词配置为空，将显示所有新闻")', 'print("Frequency words configuration is empty, will display all news")'),
...
def translate_file(input_file, output_file):
    """Translate all Chinese strings in the file"""
...
if __name__ == "__main__":
    translate_file("main.py", "main_translated.py")
